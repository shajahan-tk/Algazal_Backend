...
router.post("/project/:projectId/send-email", (0, authMiddleware_1.authorize)(["engineer", "admin", "super_admin"]), sendMailPdfController_1.sendWorkCompletionEmail);
// Add this route BEFORE the replace route
router.patch("/project/:projectId/images/:imageId", (0, authMiddleware_1.authorize)(["engineer", "admin", "super_admin"]), workCompletionController_1.updateWorkCompletionImage);
router.put("/project/:projectId/images/:imageId/replace", (0, authMiddleware_1.authorize)(["engineer", "admin", "super_admin"]), multer_1.upload.single("image"), workCompletionController_1.replaceWorkCompletionImage);
